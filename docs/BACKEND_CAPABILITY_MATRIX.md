...
| Frontend product rework | IMPLEMENTED_LIMITED | `apps/frontend`; 145 tests Vitest, typecheck et build passés; smoke connecté courant | Baseline chat-first/3D-first; erreurs et retries indépendants pour GLB/WebGL/assets/QA/RAG/provenance/documents, sans succès obsolète. Le parcours complet de création/révision générique réel reste ouvert. |
