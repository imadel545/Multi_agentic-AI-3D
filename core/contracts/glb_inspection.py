...
class GlbInspectionReport(StrictModel):
    ...
    valid_primitive_count: int = Field(default=0, ge=0)
    position_accessor_count: int = Field(default=0, ge=0)
    buffer_count: int = Field(default=0, ge=0)
    buffer_view_count: int = Field(default=0, ge=0)
    ...
    semantic_mesh_coverage_ratio: float = Field(default=0.0, ge=0.0, le=1.0)
